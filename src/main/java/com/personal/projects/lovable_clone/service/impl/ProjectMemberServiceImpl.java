...
public class ProjectMemberServiceImpl implements ProjectMemberService {
    ...
    public MemberResponse updateMemberRole(Long projectId, Long memberId, UpdateMemberRoleRequest request, Long userId) {
        ...
        Long userIdToUpdate = memberId;

        ProjectMemberId projectMemberId =
                new ProjectMemberId(projectId, userIdToUpdate);
       // ProjectMemberId projectMemberId = new ProjectMemberId(projectId, memberId);
        ProjectMember projectMember = projectMemberRepository
                .findByProjectIdAndUserId(projectId, memberId)
                .orElseThrow(() -> new RuntimeException(
                        "Member not found for projectId=" + projectId + ", userId=" + memberId
                ));
    ...
    public void removeProjectMember(Long projectId, Long memberId, Long userId) {
        ...
        boolean exists = projectMemberRepository
                .existsByProjectIdAndUserId(projectId, memberId);
        ...
        projectMemberRepository
                .deleteByProjectIdAndUserId(projectId, memberId);
